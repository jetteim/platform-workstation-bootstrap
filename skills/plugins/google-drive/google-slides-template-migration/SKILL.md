...
- If porting the content required visible local cleanup, run [visual-change-loop](../google-drive/references/slides/visual-change-loop.md) on that slide before moving on.
