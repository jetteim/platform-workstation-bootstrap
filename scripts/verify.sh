...
test -f "$repo_root/agents/skills/platform/creating-observability-pipelines/references/provider-pipeline-adapters.md"
test -f "$repo_root/agents/skills/platform/reliability-engineering/references/reliability-model-summary.md"
test -f "$repo_root/agents/skills/platform/reliability-engineering/references/provider-handoff.md"
test -f "$repo_root/agents/skills/platform/reliability-engineering/references/sre-rules-generation.md"
...
test -f "$repo_root/skills/codex/creating-observability-pipelines/references/provider-pipeline-adapters.md"
...
grep -q '^@openai/codex@0.154.0$' "$repo_root/manifests/npm-global.txt"
...
grep -q 'PipelineProviderAdapterManifest' "$repo_root/agents/skills/platform/creating-observability-pipelines/SKILL.md"
grep -q 'PipelineProviderAdapterManifest' "$repo_root/agents/skills/platform/creating-observability-pipelines/references/provider-pipeline-adapters.md"
grep -q 'datadog-observability-pipelines' "$repo_root/agents/skills/platform/creating-observability-pipelines/references/provider-pipeline-adapters.md"
grep -q 'elasticstack_elasticsearch_ingest_pipeline' "$repo_root/agents/skills/platform/creating-observability-pipelines/references/provider-pipeline-adapters.md"
grep -q 'PipelineProviderAdapterManifest' "$repo_root/skills/codex/creating-observability-pipelines/references/provider-pipeline-adapters.md"
grep -q 'vendor_imports/repos/platform-reliability-model' "$repo_root/agents/skills/platform/reliability-engineering/SKILL.md"
grep -q 'vendor_imports/repos/slo-rules-engine' "$repo_root/agents/skills/platform/reliability-engineering/SKILL.md"
grep -q 'references/reliability-model-summary.md' "$repo_root/agents/skills/platform/reliability-engineering/SKILL.md"
grep -q 'references/provider-handoff.md' "$repo_root/agents/skills/platform/reliability-engineering/SKILL.md"
grep -q 'references/sre-rules-generation.md' "$repo_root/agents/skills/platform/reliability-engineering/SKILL.md"
grep -q 'SreRulesGenerationPlan' "$repo_root/agents/skills/platform/reliability-engineering/SKILL.md"
grep -q 'rules-ctl model-report' "$repo_root/agents/skills/platform/reliability-engineering/references/sre-rules-generation.md"
grep -q 'rules-ctl generate --provider' "$repo_root/agents/skills/platform/reliability-engineering/references/sre-rules-generation.md"
grep -q 'ReliabilityProviderHandoff' "$repo_root/agents/skills/platform/reliability-engineering/references/provider-handoff.md"
grep -q 'delegated_to_observability' "$repo_root/agents/skills/platform/reliability-engineering/references/provider-handoff.md"
grep -q 'Do not generate provider Terraform from this skill' "$repo_root/agents/skills/platform/reliability-engineering/references/provider-handoff.md"
grep -q 'Prefer deterministic `sre-rules` generation' "$repo_root/agents/skills/platform/reliability-engineering/references/provider-handoff.md"
...
python3 "$repo_root/skills/codex/.system/skill-creator/scripts/quick_validate.py" \
  "$repo_root/skills/codex/engineering-agent-ready-clis"
diff -qr \
  "$repo_root/agents/skills/platform/engineering-agent-ready-clis" \
...
grep -q '^deep-research-work:deep-research$' "$repo_root/manifests/codex-skills.txt"
test -f "$repo_root/agents/skills/codex-curated/.system/review-agent/SKILL.md"
test -f "$repo_root/skills/codex/.system/review-agent/SKILL.md"
