...
- Finish the representative edited slide with [visual-change-loop](../google-drive/references/slides/visual-change-loop.md) before rolling the pattern out broadly.
